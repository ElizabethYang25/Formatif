...
public class Exercises
	{
		...
		public static void main(String[] args)
			{
				int [] myTab= {14,12,24,12,2,9,8,3,123,4,10};
		...
		{
				int min=234567650; //variable qui servira pour la baleur min
				for(int i=0;i<Tab.length;i++)
				{
					if(Tab[i]<min)
						min=Tab[i];
		...
		{
				int max=0; // variable qui servira pour la valeur la plus grande
				int pos=0; // variable pour la position de la plus grande valeur
				for(int i=0;i<Tab.length;i++)
				{
					if(Tab[i]<max)
					{
		...
		/*méthode permettant d'afficher le nombre d'éléments d'un tableau d'entiers
		 * dont la valeur est inférieure à 10
		 */
		
		static int plusPetitDix(int [] a)
		{
				int cpt=0; // computer pour les valeurs <10
		 ...
		 * quelconque est présent ou non dans un tableau d'éntiers
		 */
		...
		/*
		 * Méthode permettant de range en ordre croissant les éléments d’un 
		 * tableau d’entiers
		 */
		...
		/*méthode permettant de calculer et d'afficher la moyenne
